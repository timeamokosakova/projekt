        ...
        <form method="post" action="ob.php">
            ...
            <p>
                ...
                <div style="position: relative; top: -30px; left: 10px">
                    <b>Meno: </b> <input type="text" name="menoo" id="menoo" value="<?php echo $menoo;?>">


                    <b>Priezvisko: </b> <input type="text" name="priezo" id="priezo" value="<?php echo $priezo;?>">
            ...
            <p>
                <br>
                <div style="position: relative; top: -30px; left: 10px">
                    <b>Meno: </b> <input type="text" name="menoa" id="menoa" value="<?php echo $menoa;?>">


                    <b>Priezvisko: </b> <input type="text" name="prieza" id="prieza" value="<?php echo $prieza;?>">
            ...
            <p>
                ...
                <div style="position: relative; top: -30px; left: 100px">
                    <b>Ulica: </b>  <input type="text" name="ulica" id="ulica" value="<?php echo $ulica;?>">  <b>Číslo domu: </b>  <input type="number" name="cd" id="cd" value="<?php echo $cd;?>">
                </div>
                <div style="position: relative; top: -30px; left:100px;">
                    <b>Obec/Mesto: </b>  <input type="text" name="obec" id="obec" value="<?php echo $obec;?>">  <b>Psč: </b>  <input type="number" name="psc" id="psc" value="<?php echo $psc;?>">
                </div>

                <div style="position: relative; top: -30px;  left:100px;">
                    <b>Štát:</b> <input type="text" name="stat" id=" stat" value="<?php echo $stat;?>">
                    <br>
                </div>
                <div style="position: relative; top: -30px; left:10px">
                    <b>Druh zásielky:</b> <input type="text" name="druh" id="druh" value="<?php echo $druh;?>">
                    <b>Cena:</b> <input type="text" name="cena" id="cena" value="<?php echo $cena;?>">
                </div>
