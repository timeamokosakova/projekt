        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <p>
                ...
                <div style="position: relative; top: -30px; left: 100px">
                    <b>Ulica: </b>  <input type="text" name="ulica" value="<?php echo $ulica;?>"> <span class="error">* <?php echo $ulicaErr;?></span> <b>Číslo domu: </b>  <input type="number" name="cd" value="<?php echo $cd;?>"> <span class="error">* <?php echo $cdErr;?></span>
                </div>
                <div style="position: relative; top: -30px; left:100px;">
                    <b>Obec/Mesto: </b>  <input type="text" name="obec" value="<?php echo $obec;?>">  <span class="error">* <?php echo $obecErr;?></span> <b>Psč: </b>  <input type="number" name="psc" value="<?php echo $psc;?>"> <span class="error">* <?php echo $pscErr;?></span>
                </div>
